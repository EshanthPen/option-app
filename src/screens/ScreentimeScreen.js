...
const getStyles = (theme) => StyleSheet.create({
    ...
    card: {
        backgroundColor: theme.colors.surface, borderWidth: 1, borderColor: theme.colors.border,
        borderRadius: theme.radii.lg, padding: 20, marginBottom: 16,
    },
    ...
    timerBtn: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 24, borderRadius: theme.radii.lg, gap: 8 },
    timerBtnText: { fontFamily: theme.fonts.s, color: '#fff', fontSize: 16, fontWeight: '600' },
    ...
    timerBtnOutText: { fontFamily: theme.fonts.s, color: theme.colors.ink2, fontSize: 15, fontWeight: '500' },
